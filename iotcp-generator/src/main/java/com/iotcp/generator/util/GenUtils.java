package com.iotcp.generator.util;
...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/iotcp/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.iotcp.project.system"));
    }
}
