package com.iotcp.web.core.base;
...
public class BaseController
{
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    protected TableDataInfoBak getDataTableBak(List<?> list,List<?> list1)
    {
        TableDataInfoBak rspData = new TableDataInfoBak();
        rspData.setCode(0);
        rspData.setRows(list);
